...
import { saveToStorage, getFromStorage } from '../services/localStorageService';
import './MealLog.css';
...
const MealLog = () => {
  ...
  const searchFood = async () => {
    ...
    try {
      ...
      // Log the meal data to console for debugging
      console.log("Meal Data:", mealData);

      // Save the meal in localStorage
      const existingMeals = getFromStorage('beingFit_mealHistory', []);
      console.log("Existing Meals before saving:", existingMeals);
      existingMeals.push(mealData);
      console.log("Updated Meals after adding new meal:", existingMeals);
      const saveSuccess = saveToStorage('aleraFitness_mealHistory', existingMeals);
